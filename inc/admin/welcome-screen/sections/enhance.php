	...
	<div class="col boxed child-themes">
		...
		<div class="child-theme">
			<a href="http://www.pootlepress.com/products/outlet?utm_source=product&utm_medium=upsell&utm_campaign=fastshopaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/outlet.jpg'; ?>" alt="<?php esc_html_e( 'Proshop Child Theme', 'fastshop' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="http://www.pootlepress.com/products/proshop?utm_source=product&utm_medium=upsell&utm_campaign=fastshopaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/proshop.jpg'; ?>" alt="<?php esc_html_e( 'Proshop Child Theme', 'fastshop' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="http://www.pootlepress.com/products/galleria?utm_source=product&utm_medium=upsell&utm_campaign=fastshopaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/galleria.jpg'; ?>" alt="<?php esc_html_e( 'Galleria Child Theme', 'fastshop' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-theme&theme=boutique' ), 'install-theme_boutique' ) ); ?>">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/boutique.jpg'; ?>" alt="<?php esc_html_e( 'Boutique Child Theme', 'fastshop' ); ?>" class="image-50" />
