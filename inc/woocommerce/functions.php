 ...
 * @return  void
 */
if ( ! function_exists( 'fastshop_before_content' ) ) {
	function fastshop_before_content() {
		?>
 ...
 * @return  void
 */
if ( ! function_exists( 'fastshop_after_content' ) ) {
	function fastshop_after_content() {
		?>
			</main><!-- #main -->
		</div><!-- #primary -->
 ...
 * @since  1.0.0
 */
function fastshop_loop_columns() {
	return apply_filters( 'fastshop_loop_columns', 3 ); // 3 products per row
}
 ...
 * @since 1.6.0
 */
function fastshop_star_rating_script() {
 ...
 */
function fastshop_related_products_args( $args ) {
	$args = apply_filters( 'fastshop_related_products_args', array(
		'posts_per_page' => 3,
		'columns'        => 3,
	) );
 ...
 * @since  1.0.0
 */
function fastshop_thumbnail_columns() {
	return intval( apply_filters( 'fastshop_product_thumbnail_columns', 4 ) );
}
 ...
 * @since  1.0.0
 */
function fastshop_products_per_page() {
	return intval( apply_filters( 'fastshop_products_per_page', 12 ) );
}
