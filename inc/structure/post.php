...
if ( ! function_exists( 'fastshop_post_header' ) ) {
	/**
	 * Display the post header with a link to the single post
	 * @since 1.0.0
	 */
	function fastshop_post_header() { ?>
...
if ( ! function_exists( 'fastshop_post_content' ) ) {
	/**
	 * Display the post content with a link to the single post
	 * @since 1.0.0
	 */
	function fastshop_post_content() {
		?>
...
if ( ! function_exists( 'fastshop_post_meta' ) ) {
	/**
	 * Display the post meta
	 * @since 1.0.0
	 */
	function fastshop_post_meta() {
		?>
...
if ( ! function_exists( 'fastshop_paging_nav' ) ) {
	...
	function fastshop_paging_nav() {
		...
		$args = array(
			'type' 	    => 'list',
			'next_text' => _x( 'Next', 'Next post', 'fastshop' ) . '&nbsp;<span class="meta-nav">&rarr;</span>',
			'prev_text' => '<span class="meta-nav">&larr;</span>&nbsp' . _x( 'Previous', 'Previous post', 'fastshop' ),
			);
