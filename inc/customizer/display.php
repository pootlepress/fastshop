<?php
/**
 * fastshop Theme Customizer display functions
 *
 * @package fastshop
 */
...
if ( ! function_exists( 'fastshop_add_customizer_css' ) ) {
	function fastshop_add_customizer_css() {
		...
		$darken_factor 					= apply_filters( 'fastshop_darken_factor', -25 );
		...
		.site-header-cart:hover > li > a {
			color: ' . fastshop_adjust_color_brightness( $header_link_color, -100 ) . ';
		}
		...
		button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover, .button:hover, .added_to_cart:hover, .widget-area .widget a.button:hover, .site-header-cart .widget_shopping_cart a.button:hover {
			background-color: ' . fastshop_adjust_color_brightness( $button_background_color, $darken_factor ) . ';
			border-color: ' . fastshop_adjust_color_brightness( $button_background_color, $darken_factor ) . ';
			color: ' . $button_text_color . ';
		}
		...
		button.alt:hover, input[type="button"].alt:hover, input[type="reset"].alt:hover, input[type="submit"].alt:hover, .button.alt:hover, .added_to_cart.alt:hover, .widget-area .widget a.button.alt:hover, .added_to_cart:hover {
			background-color: ' . fastshop_adjust_color_brightness( $button_alt_background_color, $darken_factor ) . ';
			border-color: ' . fastshop_adjust_color_brightness( $button_alt_background_color, $darken_factor ) . ';
			color: ' . $button_alt_text_color . ';
		}
		...
		#order_review {
			background-color: ' . fastshop_get_content_background_color() . ';
		}
		...
		@media screen and ( min-width: 768px ) {
			...
			.secondary-navigation ul.menu a:hover {
				color: ' . fastshop_adjust_color_brightness( $header_text_color, $brighten_factor ) . ';
			}
		...
		wp_add_inline_style( 'fastshop-style', $style );
		wp_add_inline_style( 'fastshop-woocommerce-style', $woocommerce_style );
	}
}