<?php
/**
 * fastshop Theme Customizer functions
 *
 * @package fastshop
 */
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'fastshop_sanitize_hex_color' ) ) {
	function fastshop_sanitize_hex_color( $color ) {
		if ( '' === $color ) {
			return '';
        }
 ...
 * @since  1.3.0
 */
if ( ! function_exists( 'fastshop_sanitize_choices' ) ) {
 ...
 * @since 1.0.3
 */
if ( ! function_exists( 'fastshop_sanitize_layout' ) ) {
    function fastshop_sanitize_layout( $input ) {
        $valid = array(
            'right' => 'Right',
            'left'  => 'Left',
            );
 ...
 * @since  1.0.0
 */
function fastshop_layout_class( $classes ) {
	$left_or_right = get_theme_mod( 'fastshop_layout', apply_filters( 'fastshop_default_layout', $layout = is_rtl() ? 'left' : 'right' ) );
 ...
 * @since  1.5.0
 */
function fastshop_customizer_custom_control_css() {
    ?>
    <style>
 ...
 * Accounts for the Fast shop Designer's content background option.
 * @since  1.6.0
